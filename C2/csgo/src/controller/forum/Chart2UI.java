...
public class Chart2UI extends JFrame {
    ...
    public Chart2UI() {
        ...
        // 创建一个饼图
        JFreeChart chart = createChart(dataset, "槍枝中獎比例圖");
        // 将图表显示在面板中
    ...
    private DefaultPieDataset createDataset() {
        ...
        LottoViewsDaoImpl lottoDao = new LottoViewsDaoImpl();
        Map<String, Integer> gunnameCounts = lottoDao.getGunnameCounts();

        for (Map.Entry<String, Integer> entry : gunnameCounts.entrySet()) {
