...
public class Gun12UI extends JFrame {
	...
	public Gun12UI() {
		...
		JOptionPane.showMessageDialog(null, "恭喜獲得AK-47-鋼鐵三角洲!");
		...
		Member m = (Member) o;
		LottoResult l = new LottoResult(m.getMemberno(), m.getName(), gun12, amount);
