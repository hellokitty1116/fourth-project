...
public class Gun13UI extends JFrame {
	...
	public Gun13UI() {
		...
		JOptionPane.showMessageDialog(null, "恭喜獲得XM1014-象形文字!");
		...
		Member m = (Member) o;
		LottoResult l = new LottoResult(m.getMemberno(), m.getName(), gun13, amount);
