...
public class Gun4UI extends JFrame {
	...
	public Gun4UI() {
		...
		JOptionPane.showMessageDialog(null, "恭喜獲得隱藏版槍枝: AWP-刺鱗樹蝰!");
		...
		setScaledImage(lblNewLabel,"/image/pic27.png");
